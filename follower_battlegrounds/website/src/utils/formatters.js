...
export function getGameTypeInfo(gameType) {
  const gameTypes = {
    ...
    follower_pacman: {
      name: 'Follower Pac-Man',
      color: 'bg-yellow-600',
      textColor: 'text-yellow-600'
    },
    facebook_follower_pacman: {
      name: 'Follower Pac-Man',
      color: 'bg-yellow-600',
      textColor: 'text-yellow-600'
    },
    youtube_followers_follower_pacman: {
      name: 'Follower Pac-Man',
      color: 'bg-yellow-600',
      textColor: 'text-yellow-600'
    },
    follower_ferry_escape: {
      name: 'Follower Ferry Escape',
      color: 'bg-blue-700',
      textColor: 'text-blue-700'
    },
    follower_factory_sort: {
      name: 'Follower Factory Sort',
      color: 'bg-amber-700',
      textColor: 'text-amber-700'
    },
    follower_bridge_break: {
      name: 'Follower Bridge Break',
      color: 'bg-orange-700',
      textColor: 'text-orange-700'
    },
    follower_seat_scramble: {
      name: 'Follower Seat Scramble',
      color: 'bg-yellow-700',
      textColor: 'text-yellow-700'
    },
    follower_power_grid: {
      name: 'Follower Power Grid',
      color: 'bg-teal-700',
      textColor: 'text-teal-700'
    },
    follower_laser_grid: {
      name: 'Follower Laser Grid',
      color: 'bg-sky-700',
      textColor: 'text-sky-700'
    },
    follower_bumper_ring: {
      name: 'Follower Bumper Ring',
      color: 'bg-amber-600',
    ...
    follower_gate_dash: {
      name: 'Follower Gate Dash',
      color: 'bg-emerald-600',
      textColor: 'text-emerald-600'
    },
    follower_drop_tower: {
      name: 'Follower Drop Tower',
      color: 'bg-rose-600',
