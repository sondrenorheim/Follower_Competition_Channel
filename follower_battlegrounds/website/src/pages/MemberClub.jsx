...
export default function MemberClub() {
  ...
  return (
    <div className="member-club-page">
      <div className="member-club-content max-w-7xl mx-auto px-4 sm:px-8 lg:px-10 py-10 sm:py-12">
        <div className="text-center mb-12">
          <div className="club-heading text-3xl sm:text-4xl md:text-5xl text-amber-50 mb-4">
